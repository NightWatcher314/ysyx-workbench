...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->out_valid = ((1U & (~ (IData)(vlSelf->rst))) 
                         && (IData)(vlSelf->top__DOT__in_valid_r));
    vlSelf->top__DOT__in_valid_r = ((1U & (~ (IData)(vlSelf->rst))) 
                                    && (IData)(vlSelf->in_valid));
    vlSelf->top__DOT__result = 0U;
    if (vlSelf->top__DOT__in_valid_r) {
        vlSelf->top__DOT__result = (0xffU & ((1U == (IData)(vlSelf->top__DOT__op_in_r))
...
#endif
            VL_FATAL_MT("vsrc/top.v", 7, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("vsrc/top.v", 7, "", "Active region did not converge.");
            }
