...
#endif
            VL_FATAL_MT("vsrc/top.v", 7, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__a_in_r = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__b_in_r = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__in_valid_r = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__result = VL_RAND_RESET_I(8);
